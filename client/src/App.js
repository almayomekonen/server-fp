                ...
                <UserProvider>
                 ...
                 <Navbar />
                  ...
                  <Routes>
                   ...
                   <Route path="/coderHome" element={<CoderHomePage />} />
                   <Route path="/investigatorHome" element={<InvestigatorHomePage />} />
                   <Route path="/adminHome" element={<AdminHomePage />} />
                   <Route path="/edit-statement/:copyId" element={<StatementEditor />}/>
                   <Route path="/compare/:statementId" element={<ComparePage />} />
                   <Route path="/task-management" element={<TaskManagementPage />} />
                   <Route path="/task-investigator" element={<TaskForInvestigator />} />
                   <Route path="/coder-compare/:copyId" element={<CoderCompare />} />
                   <Route path="/view-statement/:copyId" element={<View />}/>
                   <Route path="/manage-colors" element={<ManageColors />} />
                   <Route path="/task-coder" element={<TaskForCoder />} />
<Route path="/task-chat/:taskId" element={<TaskChatPage />} />
<Route path="/copy-chat/:copyId" element={<CopyChatPage />} />
<Route path="/task-summary/:taskId" element={<TaskSummary />} />
<Route path="/statement-summary/:statementId" element={<StatementSummary />} />
